...
module e203_subsys_perips(
  ...
  wire                     des_aes_apb_icb_cmd_valid  ;
  wire                     des_aes_apb_icb_cmd_ready  ;
  wire [32-1:0]            des_aes_apb_icb_cmd_addr   ; 
  wire                     des_aes_apb_icb_cmd_read   ; 
  wire [32-1:0]            des_aes_apb_icb_cmd_wdata  ;
  wire [4 -1:0]            des_aes_apb_icb_cmd_wmask  ;
  
  wire                     des_aes_apb_icb_rsp_valid  ;
  wire                     des_aes_apb_icb_rsp_ready  ;
  wire [32-1:0]            des_aes_apb_icb_rsp_rdata  ;
  wire                     des_aes_apb_icb_rsp_err    ;
  ...
  //  * GPIOB      
   ...
   //  *      
    ...
    .o15_icb_cmd_valid  (des_aes_apb_icb_cmd_valid  ),
    .o15_icb_cmd_ready  (des_aes_apb_icb_cmd_ready  ),
    .o15_icb_cmd_addr   (des_aes_apb_icb_cmd_addr   ),
    .o15_icb_cmd_read   (des_aes_apb_icb_cmd_read   ),
    .o15_icb_cmd_wdata  (des_aes_apb_icb_cmd_wdata  ),
    .o15_icb_cmd_wmask  (des_aes_apb_icb_cmd_wmask  ),
    .o15_icb_cmd_lock   (),
    .o15_icb_cmd_excl   (),
    .o15_icb_cmd_size   (),
    .o15_icb_cmd_burst  (),
    ...
    .o15_icb_rsp_valid  (des_aes_apb_icb_rsp_valid  ),
    .o15_icb_rsp_ready  (des_aes_apb_icb_rsp_ready  ),
    .o15_icb_rsp_err    (des_aes_apb_icb_rsp_err    ),
    .o15_icb_rsp_excl_ok(1'b0),
    .o15_icb_rsp_rdata  (des_aes_apb_icb_rsp_rdata  ),
...
apb_gpio # (
  ...
  // DES AES
  //wire [`E203_ADDR_SIZE-1:0]  des_aes_apb_paddr   ;
  //wire                        des_aes_apb_pwrite  ;
  //wire                        des_aes_apb_pselx   ;
  //wire                        des_aes_apb_penable ;
  //wire [`E203_XLEN-1:0]       des_aes_apb_pwdata  ;
  //wire [`E203_XLEN-1:0]       des_aes_apb_prdata  ;

//  sirv_gnrl_icb2apb # (
//  .AW   (32),
//  .DW   (`E203_XLEN) 
//  ) u_des_aes_apb_icb2apb(
//    .i_icb_cmd_valid (des_aes_apb_icb_cmd_valid),
//    .i_icb_cmd_ready (des_aes_apb_icb_cmd_ready),
//    .i_icb_cmd_addr  (des_aes_apb_icb_cmd_addr ),
//    .i_icb_cmd_read  (des_aes_apb_icb_cmd_read ),
//    .i_icb_cmd_wdata (des_aes_apb_icb_cmd_wdata),
//    .i_icb_cmd_wmask (des_aes_apb_icb_cmd_wmask),
//    .i_icb_cmd_size  (),
    
//    .i_icb_rsp_valid (des_aes_apb_icb_rsp_valid  ),
//    .i_icb_rsp_ready (des_aes_apb_icb_rsp_ready  ),
//    .i_icb_rsp_rdata (des_aes_apb_icb_rsp_rdata  ),
//    .i_icb_rsp_err   (des_aes_apb_icb_rsp_err    ),

//    .apb_paddr     (des_aes_apb_paddr     ),
//    .apb_pwrite    (des_aes_apb_pwrite    ),
//    .apb_pselx     (des_aes_apb_pselx     ),
//    .apb_penable   (des_aes_apb_penable   ), 
//    .apb_pwdata    (des_aes_apb_pwdata    ),
//    .apb_prdata    (des_aes_apb_prdata    ),

//    .clk           (clk  ),
//    .rst_n         (bus_rst_n) 
//  );

//  apb_Des_Aes u_apb_Des_Aes(
//    .HCLK       (clk                    ),
//    .HRESETn    (rst_n                  ),
//    .PADDR      (des_aes_apb_paddr      ),
//    .PWDATA     (des_aes_apb_pwdata     ),
//    .PWRITE     (des_aes_apb_pwrite     ),
//    .PSEL       (des_aes_apb_pselx      ),
//    .PENABLE    (des_aes_apb_penable    ),
//    .PRDATA     (des_aes_apb_prdata     ),
//    .PREADY     (),
//    .PSLVERR    (),
...
//);
  ...
  assign io_pads_pwm0_ch0_o_oval = 1'b0;//pwm_timer0_o[0];
  assign io_pads_pwm0_ch1_o_oval = 1'b0;//pwm_timer0_o[1];
  assign io_pads_pwm0_ch2_o_oval = 1'b0;//pwm_timer0_o[2];
  assign io_pads_pwm0_ch3_o_oval = 1'b0;//pwm_timer0_o[3];
  ...
  assign io_pads_pwm1_ch0_o_oval = 1'b0;//pwm_timer1_o[0];
  assign io_pads_pwm1_ch1_o_oval = 1'b0;//pwm_timer1_o[1];
  assign io_pads_pwm1_ch2_o_oval = 1'b0;//pwm_timer1_o[2];
  assign io_pads_pwm1_ch3_o_oval = 1'b0;//pwm_timer1_o[3];
  ...
  assign io_pads_pwm2_ch0_o_oval = 1'b0;//pwm_timer2_o[0];
  assign io_pads_pwm2_ch1_o_oval = 1'b0;//pwm_timer2_o[1];
  assign io_pads_pwm2_ch2_o_oval = 1'b0;//pwm_timer2_o[2];
  assign io_pads_pwm2_ch3_o_oval = 1'b0;//pwm_timer2_o[3];
  ...
  assign io_pads_pwm3_ch0_o_oval = 1'b0;//pwm_timer3_o[0];
  assign io_pads_pwm3_ch1_o_oval = 1'b0;//pwm_timer3_o[1];
  assign io_pads_pwm3_ch2_o_oval = 1'b0;//pwm_timer3_o[2];
  assign io_pads_pwm3_ch3_o_oval = 1'b0;//pwm_timer3_o[3];
