...
typedef struct {
    __IOM uint32_t REG_TEXT0;
    __IOM uint32_t REG_TEXT1;
    __IOM uint32_t REG_TEXT2;
    __IOM uint32_t REG_TEXT3;
    __IOM uint32_t REG_KEY0;
    __IOM uint32_t REG_KEY1;
    __IOM uint32_t REG_KEY2;
    __IOM uint32_t REG_KEY3;
    __IOM uint32_t REG_ENABLE;
    __IOM uint32_t REG_MODE;
    __IOM uint32_t REG_RESULT0;
    __IOM uint32_t REG_RESULT1;
    __IOM uint32_t REG_RESULT2;
    __IOM uint32_t REG_RESULT3;
} DES_AES_TypeDef;
/**
  * @brief PWM
  */
...
#define DES_AES_BASE            (HBIRD_PERIPH_BASE + 0x50000)          /*!< (DES_AES) Base Address */
...
#define DES_AES                 ((DES_AES_TypeDef *) DES_AES_BASE)
