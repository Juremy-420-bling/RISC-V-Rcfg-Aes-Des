...
hbird_sdk/SoC/hbirdv2/Common/Source/GCC/%.o: ../hbird_sdk/SoC/hbirdv2/Common/Source/GCC/%.S
	...
	riscv-nuclei-elf-gcc -march=rv32imac -mabi=ilp32 -mcmodel=medany -mno-save-restore -O0 -ffunction-sections -fdata-sections -fno-common  -g -x assembler-with-cpp -D__IDE_RV_CORE=e203 -DSOC_HBIRD -DDOWNLOAD_MODE=DOWNLOAD_MODE_ILM -DDOWNLOAD_MODE_STRING=\"ILM\" -DBOARD_DDR200T -I"E:\nucleistudio_workspace\test_encry_decry\hbird_sdk\NMSIS\Core\Include" -I"E:\nucleistudio_workspace\test_encry_decry\hbird_sdk\SoC\hbirdv2\Common\Include" -I"E:\nucleistudio_workspace\test_encry_decry\hbird_sdk\SoC\hbirdv2\Board\ddr200t\Include" -I"E:\nucleistudio_workspace\test_encry_decry\application" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
